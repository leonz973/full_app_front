 ...
 * @property {String} active-color 圆环激活部分的颜色(该值无法动态变更)（默认#7dd05f）
 ...
 * @example <u-circle-progress active-color="#3caaff" :percent="80"></u-circle-progress>
 */
export default {
    ...
    computed: {
        ...
        circleColor() {
            if (
                ['success', 'error', 'info', 'primary', 'warning'].indexOf(
                    this.type
                ) >= 0
            )
