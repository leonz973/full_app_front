        ...
        >
            ...
            >
                <view
                    ...
                    :style="{
                        backgroundColor:
                            current < index ? 'transparent' : activeColor,
                        borderColor:
                            current < index ? unActiveColor : activeColor
                    }"
                >
                    <text
                        v-if="current < index"
                ...
                <view
                    ...
                    :style="{
                        backgroundColor:
                            index <= current ? activeColor : unActiveColor
                    }"
                ></view>
                <text
                    class="u-line-1"
 ...
 * @example <u-steps :list="numList" active-color="#d14545"></u-steps>
 */
export default {
    name: 'u-steps',
    props: {
