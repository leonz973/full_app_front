 ...
 * @property {String} active-color 滑块和激活tab文字的颜色（默认#3caaff）
        ...
        setTabColor(nowTabIndex, nextTabIndex, dx) {
            ...
            colorIndex =
                colorIndex >= colorLength
                    ...
                    : colorIndex;
            // 设置下一个tab的颜色
            this.tabsInfo[nextTabIndex].color =
                this.colorGradientArr[colorIndex];
            // 设置当前tab的颜色
