...
(function (global, factory) {
    ...
    function prepare() {
        ...
        self.createCtx = function () {
            ...
            if (id) {
                ...
                self.targetCtx =
                    self.targetCtx || uni.createCanvasContext(targetId);
            } else {
                console.error(
    ...
    function methods() {
        ...
        self.pushOrigin = self.pushOrign = function (src) {
            ...
            tools_7(self.onBeforeImageLoad) &&
                self.onBeforeImageLoad(self.ctx, self);
            ...
            return getImageInfo({
                ...
                .then(function (res) {
                    ...
                    if (innerAspectRadio < customAspectRadio) {
                        ...
                        self.rectY =
                            y - Math.abs((height - self.baseHeight) / 2);
                    } else {
                        self.rectY = y;
                ...
                .then(function () {
                    tools_7(self.onImageLoad) &&
                        self.onImageLoad(self.ctx, self);
                });
        };
