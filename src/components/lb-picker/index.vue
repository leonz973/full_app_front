...
<template>
    <view class="lb-picker">
        ...
        <view
            :class="['lb-picker-container', visible ? 'lb-picker-toggle' : '']"
        ...
        >
            ...
            >
                <view class="lb-picker-action lb-picker-left">
                    <view class="lb-picker-action-cancle" @tap="handleCancle">
                        <slot v-if="$slots['cancle-text']" name="cancle-text">
                        </slot>
                        <view
                            v-else
                ...
                <view class="lb-picker-action lb-picker-right">
                    <view class="lb-picker-action-confirm" @tap="handleConfirm">
            ...
            >
                ...
                <multi-selector-picker
                    v-if="mode === 'multiSelector' && !loading"
                    :value="value"
                    :list="list"
                    :level="level"
                    :visible="visible"
